...
class DAScroller  {
     ...
     */
    public DAScroller(Context context) {
        this(context, null);
    }
     ...
     */
    public DAScroller(Context context, Interpolator interpolator) {
        mFinished = true;
        mInterpolator = interpolator;
        float ppi = context.getResources().getDisplayMetrics().density * 160.0f;
        mDeceleration = 2							  // custom parameter
     ...
     *        point.
     */
    public void fling(int startX, int startY, float velocityX, float velocityY,
